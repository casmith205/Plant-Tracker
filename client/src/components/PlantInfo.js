...
export const PlantInfo = props => (
    ...
    //         className={'dropdown-content' + props.plantId} >
     ...
     <div>
        ...
        <ul id="plantDropdown"
            ...
            {!props.needsWater ? (
                ...
                : (
                    <li>I'm parched feed me
                        {/*  onClick = {()=> props.waterPlant(props.plantId)} */}
                        <a className="waves-effect waves-light btn-small">WATER ME</a>
                    </li>
                )}
            <li>
                {/* <span onClick={() => props.killPlant(props.plantId+ "/dead")} */}
                <span className="waves-effect waves-light btn-small grey darken-3"> DEAD</span>
            </li>
        </ul>
    </div>
